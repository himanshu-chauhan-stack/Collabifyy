...
export default function WaitlistPage() {
    ...
    const mutation = useMutation({
        ...
        onSuccess: async () => {
            await queryClient.invalidateQueries({ queryKey: ["waitlist", "user"] });
          
            toast({
              title: "Success",
              description: "Your profile has been created 🎉 Redirecting you...",
            });
          
            setTimeout(() => {
              setLocation("/home"); // 👈 Redirect to profile homepage
            }, 400);
          },
        onError: (error: Error) => {
